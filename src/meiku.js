...
export const MEIKU_ROUND_SIZE = 10;

export function normalizeMeikuAnswer(value) {
  return String(value)
    .trim()
    .replace(/[\s　、。,.!！?？「」『』]/g, '')
...
export function isMeikuCorrect(question, answer) {
